...
namespace LM {
    ...
    RenderableGuiGroup::RenderableGuiGroup(Vector<Ref<RenderableGui>> renderables,
    ...
    void RenderableGuiGroup::onEvent(Ref<Event> event) {
        ...
        dispatcher.dispatch<MouseMovedEvent>([&](Ref<MouseMovedEvent> e) {
            ...
            for (auto& renderable : m_Renderables) {
                Ref<MouseMovedEvent> newEvent =
                    CreateRef<MouseMovedEvent>(e->getX() - m_Position.x - m_AlignPosition.x,
    ...
    glm::vec2 RenderableGuiGroup::getSize() const { return glm::uvec2(0, 0); }
